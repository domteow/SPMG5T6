...
class TestSkill(flask_testing.TestCase):
    ...
    def test_check_skill_exists(self): 
        self.maxDiff = None
        self.assertEqual(Skill.check_skill_exists('Python Programming').to_dict(), 
            {'active': 1,
             'skill_desc': 'Python is often used as a support language for software '
    ...
    def test_error_create_skill(self): 
        self.assertEqual(Skill.create_skill(skill_id=201, skill_name="Digital marketing", skill_desc='Digital marketing is both creative (photography, writing, and design) and analytical (Google Analytics, CRO, marketing automation)', active=1)
        ,False)
